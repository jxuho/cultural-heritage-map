...
export const usePlaceReviews = (placeId: string | undefined, isExpanded: boolean) => {
...
export const useMyReviews = (sortOption: 'newest' | 'oldest' | 'highest' | 'lowest' = 'newest') => {
  return useQuery<Review[], Error>({
...
type ReviewMutationVariables = 
  | { actionType: 'create'; placeId: string; reviewData: ReviewInput; reviewId?: never }
  | { actionType: 'update'; placeId: string; reviewId: string; reviewData: ReviewInput }
  | { actionType: 'delete'; placeId: string; reviewId: string; reviewData?: never };
  ...
  return useMutation<Review | boolean | null, Error, ReviewMutationVariables>({
    mutationFn: async (variables) => {
      ...
      switch (actionType) {
        ...
        case 'update':
          return updateReview(placeId, variables.reviewId, variables.reviewData);
        case 'delete':
